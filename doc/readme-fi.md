...
* `Shift+N`: Edellinen kommentti.
* `N`: Seuraava kommentti.
* `Ctrl+B`: Siirry kaikkiin kirjanmerkkeihin ja kommentteihin.
* `Ctrl+Alt+B`: Siirry vain kirjanmerkkeihin.
* `Ctrl+Alt+M`: Siirry vain kommentteihin.
* `Ctrl+Shift+W`: Näytä kommentin teksti nykyisessä sijainnissa.
...
* Lisätty valinnainen äänipalaute kirjanmerkin tai kommentin kohdalle siirtymisestä. Kiitos Andre Louis'lle merkkiäänistä. [#110](https://github.com/trypsynth/paperback/issues/110).
