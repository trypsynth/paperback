...
* `Ctrl+E`: Vie nykyinen asiakirja muotoilemattomana tekstinä.
...
* Lisätty pb-komentorivityökalu, jolla voi muuntaa nopeasti minkä tahansa Paperbackin tukeman tiedostomuodon HTML-, Markdown- tai tekstimuotoon.
...
* Vientitoimintoa laajennettu siten, että se mahdollistaa viennin muotoilemattoman tekstin lisäksi myös HTML- ja Markdown-muodoissa.
* Korjattu virhe, joka aiheutti kohdistuksen siirtymistä asiakirjan alkuun tekstin rivitystä käyttöön otettaessa.
* Tilarivillä ei näytetä enää virheellisiä DAISY-kirjojen tietoja.
...
* Paperback käyttää nyt varavaihtoehtona muotoilemattoman tekstin poimimista sellaisista PDF-tiedostoista, , joiden tagit on merkitty virheellisesti.
...
* Korjattu virhe, joka aiheutti EPUB-kirjoissa olevien ulkoisten linkkien automaattisen aktivoinnin selainnäkymää avattaessa.
...
* ZIP-kirjasto on vaihdettu, jotta sovelluksella voidaan avata entistä useampia EPUB-kirjoja. [#73](https://github.com/trypsynth/paperback/issues/73).
* Valintaikkuna, joka kysyy asiakirjan avaamista muotoilemattomana tekstinä, on uudistettu kokonaan ja se mahdollistaa nyt asiakirjan avaamisen sekä muotoilemattomana tekstinä että HTML- ja Markdown-muodoissa.
