...
elseif(VCPKG_TARGET_IS_OSX)
	file(INSTALL "${SOURCE_PATH}/lib/libpdfium.dylib" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
	if(EXISTS "${SOURCE_PATH}/debug/lib/libpdfium.dylib")
		file(INSTALL "${SOURCE_PATH}/debug/lib/libpdfium.dylib" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
	else()
		file(INSTALL "${SOURCE_PATH}/lib/libpdfium.dylib" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
	endif()
else()
