...
class PlaybackService : Service() {
	...
	companion object {
		...
		const val ACTION_PLAY = "dev.paperback.android.ACTION_PLAY"
		const val ACTION_PAUSE = "dev.paperback.android.ACTION_PAUSE"
		const val ACTION_NEXT = "dev.paperback.android.ACTION_NEXT"
		const val ACTION_PREV = "dev.paperback.android.ACTION_PREV"
		const val ACTION_STOP = "dev.paperback.android.ACTION_STOP"
