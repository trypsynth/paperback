 ...
 * plus the sleep timer countdown while one is running. Find is a navigation unit in this mode,
 * with its own buttons in the bottom bar, so the text needs no find actions of its own.
 */
@Composable
fun ReadAloudPane(
	segmentText: String,
